...
const Payments = () => {
  ...
  <div className="card">
    ...
    <div id="collapseOne" className="collapse show p-3" aria-labelledby="headingOne" data-parent="#accordion">
     <div className="form-group">
     <label className='d-block'>Card Number</label>
         <input type="number" name="cardNumber" id="cardNumber" onChange={(e) => setName(e.target.value)} />
     </div>
     <div className="form-group">
     <label className='d-block'>Expiration Date</label>
         <div className="row">
           <div className="col">
         <input type="number" name="expiratonMonth" id="expiratonMonth" onChange={(e) => setExpirationMonth(e.target.value)} placeholder='Month' />
  ...
  <option value="audi">Audi</option>
           ...
           <div className="col">
         <input type="number" name="expiratonYear" id="expiratonYear" onChange={(e) => setExpirationYear(e.target.value)} placeholder='Year' />
           </div>
         </div>
     </div>
     <div className="form-group">
     <label className='d-block'>CVV</label>
         <input type="number" name="cvv" id="cvv" onChange={(e) => setCvv(e.target.value)} />
     </div>
     <div className="form-group">
     <label className='d-block'>Card Holder Name</label>
         <input type="number" name="cardNumber" id="cardNumber" onChange={(e) => setCardNum(e.target.value)} />
     </div>
     <div className="form-group">
     <label className='d-block'>Amount</label>
       <input type="text" disabled value={amount} />
     </div>
    <div className="btn btn-primary" onClick={handleCreditPayment}>Pay</div>
    </div>
  </div>
  <div className="card">
    ...
    <div id="collapseTwo" className="collapse p-3" aria-labelledby="headingTwo" data-parent="#accordion">
    <div className="form-group">
    <label className='d-block'>Card Number</label>
         <input type="number" name="cardNumber" id="cardNumber" onChange={(e) => setCardNum(e.target.value)} />
     </div>
